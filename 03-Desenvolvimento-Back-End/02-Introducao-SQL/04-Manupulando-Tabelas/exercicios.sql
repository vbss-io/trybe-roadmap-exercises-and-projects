-- Exercícios
-- Restaurando Banco de Dados Pixar
...
-- 2) O filme Procurando Nemo foi classificado em 6.8, fez 450 milhões no mercado interno e 370 milhões no mercado internacional.
-- Insira as informações à tabela BoxOffice.
INSERT INTO pixar.boxoffice
	(movie_id, rating, domestic_sales, international_sales)
VALUES (
	(SELECT id FROM pixar.movies WHERE title = 'Procurando Nemo'),
    6.8,
    450000000,
    370000000
);
...
-- 4) O título do filme "Ratatouille" está incorreto na tabela Movies. Além disso, o filme foi lançado em 2007 e não em 2010.
...
-- 9) Altere a classificação da tabela BoxOffice para 6.0 de todos os filmes que lucraram menos de 300 milhões no mercado
