...
function checkFridayOrHolliday(day) {
  ...
  if (currentDay.innerHTML === '4' || currentDay.innerHTML === '11' || currentDay.innerHTML === '18') {
    return 'day friday';
  }
...
// 2 - Crie butão dinamicamente com aa string feriados 
...
// 4 - Crie butão dinamicamente com aa string sexta-feira
...
// 6 - Aumentar o texto do dia com mouse ouver e diminuir com mouse out
